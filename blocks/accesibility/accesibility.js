...
export default async function decorate(block) {
  const originalRows = [...block.children].map((row) => row.cloneNode(true));
  const headerRow = originalRows.shift();
